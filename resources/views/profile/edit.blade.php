...
@push('css')
    <style>
        /* ============================= */
        /* Fade-in effect for profile photo */
        /* ============================= */
        .fade-in {
            opacity: 0;
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="profile-container">
                ...
                <div>
                    ...
                    <form id="photoForm" method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data"
                        style="display: none;">
                        @csrf
                        @method('patch')
                            ...
                            <div class="profile-photo-wrapper" onclick="document.getElementById('profile_photo').click();">
                                <div class="profile-photo-inner">
                                    <img id="profilePhotoImg" class="profile-photo-img fade-in show"
                                        src="{{ auth()->user()->profile_photo_path ? asset('storage/' . auth()->user()->profile_photo_path) . '?v=' . time() : asset('assets/img/default-avatar.png') }}"
                                        alt="{{ auth()->user()->name }}">
                                </div>
                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="input-role" class="form-control"
                                    value="{{ ucfirst(auth()->user()->role ?? 'staff') }}" readonly disabled>
                            </div>
                            ...
                            <div class="text-center-btn" style="margin-top: 30px;">
                                <button type="submit" class="btn-gradient-primary">
                                    <i class="fa fa-check-circle"
                                        style="margin-right: 8px;"></i>{{ __('Simpan Perubahan') }}
                                </button>
                            </div>
                        </form>
                    </div>
                        ...
                        <form method="post" action="{{ route('profile.password') }}">
                            ...
                            <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                ...
                                <input type="password" name="old_password" id="input-current-password"
                                    ...
                                    placeholder="{{ __('Masukkan kata sandi saat ini') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                ...
                                <input type="password" name="password" id="input-password"
                                    ...
                                    placeholder="{{ __('Masukkan kata sandi baru') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_confirmation" id="input-password-confirmation"
                                    class="form-control" placeholder="{{ __('Konfirmasi kata sandi baru') }}" required>
                            </div>
                ...
                <div class="modern-card user-preview-card" style="animation-delay: 0.3s;">
                    ...
                    <div class="preview-content">
                        ...
                        <!-- Profile Status -->
                        <div
                            style="padding: 20px; background: rgba(23, 162, 184, 0.05); border-radius: 10px; margin-top: 20px;">
                            ...
                            <p style="font-size: 0.85rem; color: #999; margin: 0;">
                                ...
                                {{ auth()->user()->updated_at ? auth()->user()->updated_at->format('d M Y H:i') : 'N/A' }}
                            </p>
                        </div>
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            // ============================================
            // PROFILE PHOTO PREVIEW & UPLOAD (FIXED)
            // ============================================
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                profilePhotoInput.addEventListener('change', function(e) {
                    ...
                    // Show local preview first (fade-in effect)
                    ...
                    reader.onload = function(event) {
                        ...
                        // Wait for fade-out, then update src
                        setTimeout(() => {
                ...
                // ============================================
                function uploadPhotoViaAjax(file) {
                    ...
                    .then(data => {
                        if (data.status === 'success') {
                            ...
                            console.log('{{ __("Foto profil berhasil diperbarui") }}');
                        } else {
                            console.error('Upload error:', data.message);
                        }
                    })
                    .catch(error => {
                        console.error('{{ __("Terjadi kesalahan saat mengunggah foto:") }}', error);
                        alert('{{ __("Gagal mengunggah foto. Silakan coba lagi.") }}');
                    });
                }
                ...
                // ============================================
                const forms = document.querySelectorAll('form:not(#photoForm)');
                forms.forEach(form => {
